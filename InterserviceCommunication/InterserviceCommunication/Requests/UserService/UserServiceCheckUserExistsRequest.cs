...
{
    /// <summary>
    /// Запрос проверки существование пользователя
    /// </summary>
    public sealed class UserServiceCheckUserExistsRequest : InterserviceRequest
    {
        ...
        public UserServiceCheckUserExistsRequest(UserServiceConnector connector, Guid? userId = null, string? userName = null)
        {
            _httpMethod = HttpMethod.Get;
            _route = "api/v1/user-exists";
